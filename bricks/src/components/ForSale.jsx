  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        const res = await axios.get('https://bricks-keys.vercel.app/api/properties?type=For Sale');
    ...
    <div style={styles.container}>
      ...
      {properties.length > 0 ? (
          ...
          {properties.map(property => (
            ...
            >
              ...
              <div style={styles.cardContent}>
                ...
                <div style={styles.propertyPrice}>PKR {property.price}</div>
        ...
        <div style={{ textAlign: 'center', padding: '50px' }}>
          <h3 className="text-muted">No properties for sale at the moment.</h3>
